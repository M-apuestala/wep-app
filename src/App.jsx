    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans p-4 flex flex-col justify-between app-container">
      ...
      <main className="max-w-md w-full mx-auto space-y-4 interface-screen">
        ...
        <div className="pt-4">
          <button
            type="button"
            onClick={() => window.open('/ticket-hipico.html', '_blank')}
            className="w-full py-3 px-4 rounded-xl bg-slate-700 text-slate-100 font-semibold hover:bg-slate-600 transition"
          >
            Abrir Ticket Hípico en nueva pestaña
          </button>
        </div>
